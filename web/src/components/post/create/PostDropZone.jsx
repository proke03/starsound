  ...
  return (
    <>
      <div className="relative">
        ...
        <label
          htmlFor="input-file"
          className="pl-2 select-none cursor-pointer flex items-center justify-center text-base text-tertiary h-30 border border-dashed dark:border-gray-700 rounded-md transition dark:hover:bg-gray-775"
        >
