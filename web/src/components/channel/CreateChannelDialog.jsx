    ...
    >
      <div className="p-5 space-y-4 w-full text-left">
        <div className="flex items-center font-semibold text-primary">
          ...
          &nbsp;&nbsp;&middot;&nbsp;&nbsp;{channel ? t('channel.edit') : t('channel.create.label')}
          <IconX
        ...
        <div className="flex items-center space-x-4 text-sm text-tertiary">
          <Tippy content={t('channel.type.public.description')}>
            <div
            ...
            >
              ...
              {t('channel.type.public.label')}
            </div>
          </Tippy>

          <Tippy content={t('channel.type.restricted.description')}>
            <div
            ...
            >
              ...
              {t('channel.type.restricted.label')}
            </div>
          </Tippy>

          <Tippy content={t('channel.type.private.description')}>
            <div
